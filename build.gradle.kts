...
bukkit {
    name = "Vaycore-global"
    description = "This is a global plugin for all nodes of Vaycore adding general functionalities and APIs."
    main = "$group.vaycoreglobal.Main"
    version = "1.0.0"
